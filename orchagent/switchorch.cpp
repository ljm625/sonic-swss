...
const int SAI_SWITCH_ATTR_EXT_ECMP_HASH_OFFSET = SAI_SWITCH_ATTR_CUSTOM_RANGE_BASE+3;
const int SAI_SWITCH_ATTR_EXT_LAG_HASH_OFFSET = SAI_SWITCH_ATTR_CUSTOM_RANGE_BASE+4;
